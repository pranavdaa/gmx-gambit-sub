...
export class ChainlinkAggregator__getBillingResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkAggregator__getRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkAggregator__latestConfigDetailsResult {
  value0: BigInt;
  value1: BigInt;
  value2: Bytes;
...
export class ChainlinkAggregator__latestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkAggregator__validatorConfigResult {
  value0: Address;
  value1: BigInt;
...
export class ChainlinkAggregator extends ethereum.SmartContract {
  ...
  getBilling(): ChainlinkAggregator__getBillingResult {
    let result = super.call(
      "getBilling",
    ...
    return new ChainlinkAggregator__getBillingResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getBilling(): ethereum.CallResult<ChainlinkAggregator__getBillingResult> {
    let result = super.tryCall(
      "getBilling",
      "getBilling():(uint32,uint32,uint32,uint32,uint32)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new ChainlinkAggregator__getBillingResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getRoundData(_roundId: BigInt): ChainlinkAggregator__getRoundDataResult {
    let result = super.call(
      "getRoundData",
    ...
    return new ChainlinkAggregator__getRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getRoundData(
    _roundId: BigInt,
  ): ethereum.CallResult<ChainlinkAggregator__getRoundDataResult> {
    let result = super.tryCall(
      "getRoundData",
      "getRoundData(uint80):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkAggregator__getRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestConfigDetails(): ChainlinkAggregator__latestConfigDetailsResult {
    let result = super.call(
      "latestConfigDetails",
    ...
    return new ChainlinkAggregator__latestConfigDetailsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBytes(),
    );
  ...
  try_latestConfigDetails(): ethereum.CallResult<ChainlinkAggregator__latestConfigDetailsResult> {
    let result = super.tryCall(
      "latestConfigDetails",
      "latestConfigDetails():(uint32,uint32,bytes16)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkAggregator__latestConfigDetailsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBytes(),
      ),
  ...
  latestRoundData(): ChainlinkAggregator__latestRoundDataResult {
    let result = super.call(
      "latestRoundData",
    ...
    return new ChainlinkAggregator__latestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_latestRoundData(): ethereum.CallResult<ChainlinkAggregator__latestRoundDataResult> {
    let result = super.tryCall(
      "latestRoundData",
      "latestRoundData():(uint80,int256,uint256,uint256,uint80)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkAggregator__latestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestTransmissionDetails(): ChainlinkAggregator__latestTransmissionDetailsResult {
    let result = super.call(
    ...
    return new ChainlinkAggregator__latestTransmissionDetailsResult(
      result[0].toBytes(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toBigInt(),
  ...
  try_latestTransmissionDetails(): ethereum.CallResult<ChainlinkAggregator__latestTransmissionDetailsResult> {
    let result = super.tryCall(
      "latestTransmissionDetails",
      "latestTransmissionDetails():(bytes16,uint32,uint8,int192,uint64)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkAggregator__latestTransmissionDetailsResult(
        value[0].toBytes(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toBigInt(),
  ...
  validatorConfig(): ChainlinkAggregator__validatorConfigResult {
    let result = super.call(
      "validatorConfig",
    ...
    return new ChainlinkAggregator__validatorConfigResult(
      result[0].toAddress(),
      result[1].toBigInt(),
    );
  }

  try_validatorConfig(): ethereum.CallResult<ChainlinkAggregator__validatorConfigResult> {
    let result = super.tryCall(
      "validatorConfig",
      "validatorConfig():(address,uint32)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkAggregator__validatorConfigResult(
        value[0].toAddress(),
        value[1].toBigInt(),
      ),
    );
